...
# 𐀀 ALSHAFEY.BOTS. _______________________________________________________
...
# ALSHAFEY.BOTS _______________________________________________________
...
def kick(group, target, hlthfail=None):
    try:
...
if __name__ == '__main__':
    run()
    print('\n》》》》PROGRAM STARTED《《《《\n')
    threading.Thread(target=loop.run_until_complete(alshafey)).start()
